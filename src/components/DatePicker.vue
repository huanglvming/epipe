<template>
  <div class="date-picker">
    <div class="date-header">
      <div class="arrow arrow-left" @click="goleft">
    ...
    <div class="date-content" v-show="showPicker" @click="closePicker">
...
<script>
  ...
  function setDaysArr(year,month){
    ...
    /*计算当月1号对应星期几*/
    let blankLenth = (new Date(year+'/'+month+'/1').getDay() - 1)>0?(new Date(year+'/'+month+'/1').getDay() - 1):0;
  ...
  export default{
    ...
    methods:{
      ...
      goleft(){
        this.dateCouter --;
        let ms = new Date().getTime() + this.dateCouter*24*60*60*1000;
